   ...
   // Переменная, означающая сколько цифр пагинации отображать    
    ...
    // $pages_count - сколько всего страниц
        ...
        $out = '';
         if($pages_count > 1) {
            if($page > 1) {
                $out .= "<li class=''>" . "<a href=\"{$_SERVER['PHP_SELF']}"."?mode=w_js"."$param".((isset($_GET['tab'])) || (isset($_GET['id'])) || (isset($_GET['url'])) ? "" : "&") . "page=1\" onclick=\"getData('$url', {page : '1'" . ((isset($_GET['tab']) && $_GET['tab'] == 'new') ? ', tab : \'new\'' : '') . ((isset($_GET['tab']) && $_GET['tab'] == 'rating') ? ', tab : \'rating\'' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? ', id : ' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? $cat_id : '')."}); return false;\">◀" . '</a></li>';

                $out .= "<li class=''>" . "<a href=\"{$_SERVER['PHP_SELF']}"."?mode=w_js"."$param".((isset($_GET['tab'])) || (isset($_GET['id'])) || (isset($_GET['url'])) ? "" : "&") . "page=" . ($page - 1) ."\" onclick=\"getData('$url', {page : " . ($page - 1) . ((isset($_GET['tab']) && $_GET['tab'] == 'new') ? ', tab : \'new\'' : '') . ((isset($_GET['tab']) && $_GET['tab'] == 'rating') ? ', tab : \'rating\'' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? ', id : ' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? $cat_id : '')."}); return false;\">◀◀" . '</a></li>';
            }
            foreach($pagesOut as $p)

                $out .= (($p == $current_page) ? "<li class='active'>" : "<li class=''>") . "<a href=\"{$_SERVER['PHP_SELF']}"."?mode=w_js"."$param".((isset($_GET['tab'])) || (isset($_GET['id'])) || (isset($_GET['url'])) ? "" : "&") . "page={$p}\" onclick=\"getData('$url', {page : '$p'" . ((isset($_GET['tab']) && $_GET['tab'] == 'new') ? ', tab : \'new\'' : '') . ((isset($_GET['tab']) && $_GET['tab'] == 'rating') ? ', tab : \'rating\'' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? ', id : ' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? $cat_id : '')."}); return false;\">{$p}" . '</a></li>';

            if($page < $pages_count) {
                $out .= "<li class=''>" . "<a href=\"{$_SERVER['PHP_SELF']}"."?mode=w_js"."$param".((isset($_GET['tab'])) || (isset($_GET['id'])) || (isset($_GET['url'])) ? "" : "&") . "page=" . ($page + 1) ."\" onclick=\"getData('$url', {page : " . ($page + 1) . ((isset($_GET['tab']) && $_GET['tab'] == 'new') ? ', tab : \'new\'' : '') . ((isset($_GET['tab']) && $_GET['tab'] == 'rating') ? ', tab : \'rating\'' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? ', id : ' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? $cat_id : '')."}); return false;\">▶▶" . '</a></li>';

                $out .= (($page < $pages_count) ? "<li class=''>" : "<li class=''>") . "<a href=\"{$_SERVER['PHP_SELF']}"."?mode=w_js"."$param".((isset($_GET['tab'])) || (isset($_GET['id'])) || (isset($_GET['url'])) ? "" : "&")."page={$pages_count}\" onclick=\"getData('$url', {page : '{$pages_count}'" . ((isset($_GET['tab']) && $_GET['tab'] == 'new') ? ', tab : \'new\'' : '') . ((isset($_GET['tab']) && $_GET['tab'] == 'rating') ? ', tab : \'rating\'' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? ', id : ' : '') . ((isset($_GET['id'])) || (isset($_GET['url'])) ? $cat_id : '')."}); return false;\">▶" . '</a></li>';
            }
        }
        echo($out);
        ?>
