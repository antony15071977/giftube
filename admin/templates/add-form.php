...
<h2 class="">Добавить ITEM</h2>
<br>
<form class="form" id="add-form" action="/admin/add.php" method="post" enctype="multipart/form-data">
    <div class="form__columns">
        ...
        <div class="form__column">
            ...
            <?php $classname = isset($errors['author']) ? "form__input--error" : "";
            $value = isset($gif['author']) ? $gif['author'] : "";
            $value_input = isset($gif['author_input']) ? $gif['author_input'] : ""; ?>
